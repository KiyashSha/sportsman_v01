...
urlpatterns = [
    ...
    path('students-all/<student_classcode>', views.students_all, name="students_all"),
    path('search_results/', views.student_search, name="student_search" ),
    ...
    path('details/<int:student_admno>/update/',views.update_student, name="student_update"),
